...
function likeIt(){
  alert('Thank you for liking my gaming app!');
}

function showHide() {
  var readMoreDiv = document.getElementById("readmore");
  readMoreDiv.style.color = "white";
...
function welcomeUser() {
  ...
  document.getElementById('welcomeuser').innerHTML = '<p> Hello, ' + username + ', looking forward to reading your favourite Games! Click this message to close it.</p>';
